...
👉 현재 현업에서 PL/SQL + 전자정부프레임워크로 개발된 프로젝트를 유지보수중이어서 SQL에 대한 이해도가 좋습니다.

👉 또한 MSA구조로 개발된 프로젝트를 유지보수중이어서 현재 최신 프레임워크와 최신 아키텍처에 대한 이해도도 좋습니다.

👉 sql로 도배되어 있는 프로젝트를 유지보수중이고, 객체지향 원툴로 만들어진 프로젝트도 유지보수중입니다.

👉 모놀로틱 아키텍처와 MSA아키텍처의 프로젝트를 전부 운영/유지보수중이므로 각각의 장점과 한계점 역시 모두 몸으로 체감중입니다..
